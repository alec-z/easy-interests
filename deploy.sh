...
kubectl set image deployments/interests-front-deployment interests-front=aleczheng/license-front:$SHA
kubectl set image deployments/interests-back-deployment interests-back=aleczheng/license-back:$SHA
